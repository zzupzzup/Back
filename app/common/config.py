...
class LocalConfig(Config):
    ...
    DB_URL: str = "mysql+pymysql://root:wotjddlWkd@jsdb.cojmnvjt9cfs.ap-northeast-2.rds.amazonaws.com:3306/notification_api?charset=utf8mb4" # aws 에 배포한 서버와 연결 #aws database
